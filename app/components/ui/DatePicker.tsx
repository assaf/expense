  ...
  return (
    <div ref={wrapRef} className={cn("relative", className)}>
      <input
        ...
        className={cn(inputVariants({ invalid }), "pr-9", valueTone)}
        value={value}
        disabled={disabled}
      ...
      <button
        ...
        disabled={disabled}
        onClick={openPicker}
        className="absolute right-1.5 top-1/2 -translate-y-1/2 rounded-md p-1.5 text-gray-500 hover:text-gray-700 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 disabled:cursor-not-allowed disabled:opacity-50 dark:text-gray-400 dark:hover:text-gray-200"
      >
