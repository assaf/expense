...
/** The app home: one account's expenses. `/` is the marketing landing
 * page, so the list lives here and is never shared-cached. */
...
/**
 * One account's expenses: never cached, and never negotiated for markdown
 * (there is no mirror), so the shared security and discovery headers are
 * all this page adds. A route's headers replace the root's rather than
 * merging, which is why they are spread in here.
 */
