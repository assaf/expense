  ...
  if (intent === "upload") {
    ...
    if (!(file instanceof File) || file.size === 0) {
      return Response.json(
        { error: "Choose a statement file (CSV, QFX/OFX, or PDF)." },
        { status: 400 },
      );
    }
    ...
    <div className="flex flex-col gap-6">
      <section className="rounded-xl border border-gray-200 bg-white p-6">
        ...
        <p className="mb-4 text-sm text-gray-500">
          ...
          upload them here — CSV, QFX/OFX, or PDF. Expense matches every charge
          against your logged receipts; you review the close matches and decide
          what to keep. Nothing is changed until you finish.
        </p>
        <fetcher.Form
          method="post"
        ...
        >
          ...
          <label className="flex flex-col gap-2">
            ...
            <input
              type="file"
              name="file"
              accept=".csv,.qfx,.ofx,.pdf,text/csv,application/pdf"
