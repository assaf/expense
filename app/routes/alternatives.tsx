...
export function meta(): Route.MetaDescriptors {
  return pageMeta(
    ...
    "Expense is a free alternative to Expensify for personal and small-team expense tracking: OCR receipt capture, AI categories, Schedule C-based categories, mileage at the IRS rate, and tax-time exports. Also compares Zoho Expense, SparkReceipt, Shoeboxed, and Wave.",
    "/alternatives",
  );
}
