...
export const MERCHANT_POLICIES: readonly MerchantPolicy[] = [
  ...
  },
  {
    ...
    terms: "Costco Tire's own coverage: the Road Hazard Warranty covers unrepairable road-hazard damage on tires bought at Costco for 60 months or until 2/32 inch of tread remains, credited pro rata toward a new tire, and the installation package includes lifetime rotations, balancing, and flat repairs.",
    sources: [
  ...
  {
    merchant: "Best Buy",
    terms: "Best Buy's own coverage: 15-day returns on most products, 60 days for My Best Buy Plus and Total members (Marketplace items excluded). Geek Squad Protection can be added within 60 days of purchase, and covers service and accidental damage with a service fee per claim.",
    sources: [
  ...
  {
    merchant: "Target",
    terms: "Target's own coverage: 90 days on most items, 30 days on electronics and entertainment and 14 days on Apple, Beats, and mobile phones, and a one-year window with receipt on Target's own brands. A Target Circle Card adds 30 days to most purchases.",
    sources: [
  ...
  {
    merchant: "Apple",
    terms: "Apple's own coverage: a one-year limited warranty on hardware, and 14-day returns from the date you receive the item, repackaged with everything it shipped with. AppleCare+ (bought with the device or within 60 days of the purchase) extends the hardware coverage and adds accidental-damage protection.",
    sources: [
  ...
  {
    merchant: "REI",
    terms: "REI's own coverage: a 100% Satisfaction Guarantee, so an unsatisfied purchase can be returned for a replacement or refund within one year of the purchase date for a Co-op member, and within 90 days for a non-member, with a few exceptions (in-store Re/Supply used gear, memberships, lift tickets, passes and gift cards).",
    sources: [
      "https://www.rei.com/help/return-policy",
    ],
    asOf: "2026-09",
  },
  {
