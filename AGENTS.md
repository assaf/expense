...
- Reconciliation (`docs/reconciliation.md`), receipts-by-email (`docs/receipts-by-email.md`), accounts (`docs/accounts.md`), image keys `images/{accountId}/…` named `YYYY-MM-DD_REPORT_FILE.ext` (legacy migration: `scripts/migrate-legacy`).
