...
| `app/routes/settings.tsx`          | Reports, categories, current IRS mileage rates (one line, from the master table), home location, receipts-by-email sender, Agents & API (MCP) tokens.                                                                                                                                                                             |
