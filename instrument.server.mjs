...
// Only emit to the Sentry project from the Vercel production runtime. The
// same start script (NODE_OPTIONS --import) runs for local dev and the test
// server, which must not send dev/test noise to the production project.
